...
//------------------------------普通上传------------------------------
function UCloud_PutFile($bucket, $key, $file, $putPolicy = null)
{
    ...
    $client = new UCloud_AuthHttpClient(null, $mimetype, HEAD_FIELD_CHECK, $putPolicy);
...
function UCloud_MFinish($bucket, $key, $uploadId, $etagList, $newKey = '', $putPolicy = null)
{
    ...
    $client = new UCloud_AuthHttpClient(null, null, HEAD_FIELD_CHECK, $putPolicy);
    return UCloud_Client_Call($client, $req);
}
